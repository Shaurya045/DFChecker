...
const MotionQuestion = ({
  ...
  const validateAnswers = () => {
    ...
    const isSkin1Checked =
      answers['motion4']?.left || answers['motion4']?.right;
  ...
  return (
    <>
          ...
          <View style={styles.modalContent}>
            ...
            <View style={{marginBottom: 15}}>
              <Text style={{fontSize: 15, fontWeight: '400', marginBottom: 7}}>
                <Text style={{fontWeight: 'bold'}}>{t('Motion.title1')}:</Text>{' '}
                {t('Motion.text1')}
              </Text>
              <Text style={{fontSize: 15, fontWeight: '400', marginBottom: 7}}>
                <Text style={{fontWeight: 'bold'}}>{t('Motion.title2')}:</Text>{' '}
                {t('Motion.text2')}
              </Text>
              <Text style={{fontSize: 15, fontWeight: '400', marginBottom: 7}}>
                <Text style={{fontWeight: 'bold'}}>{t('Motion.title3')}:</Text>{' '}
                {t('Motion.text3')}
              </Text>
              <Text style={{fontSize: 15, fontWeight: '400', marginBottom: 7}}>
                <Text style={{fontWeight: 'bold'}}>{t('Motion.title4')}:</Text>{' '}
                {t('Motion.text4')}
              </Text>
              <Text style={{fontSize: 15, fontWeight: '400', marginBottom: 7}}>
                <Text style={{fontWeight: 'bold'}}>{t('Motion.title5')}:</Text>{' '}
                {t('Motion.text5')}
              </Text>
            </View>
            <TouchableOpacity
      ...
      <View style={styles.titleBox}>
        <Text style={styles.titleTxt}>{t('Motion.title8')}</Text>
      </View>
      <View>
        <Text
          style={{
        ...
        <View style={styles.heading} key={item.id}>
          ...
          <View style={styles.buttonGroup}>
            ...
            <TouchableOpacity
              style={styles.button}
              onPress={() => {
                // If motion1 is being checked, uncheck all other left checkboxes
                if (item.id === 'motion1' && !answers[item.id]?.left) {
                  questions.forEach(question => {
                    if (question.id !== 'motion1') {
              ...
              disabled={
                (answers['motion1']?.left && item.id !== 'motion1') ||
            ...
            <TouchableOpacity
              style={styles.button}
              onPress={() => {
                // If motion1 is being checked, uncheck all other right checkboxes
              ...
              disabled={
                (answers['motion1']?.right && item.id !== 'motion1') ||
