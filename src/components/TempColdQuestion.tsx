...
const TempColdQuestion = ({
  ...
  const validateAnswers = () => {
    ...
    const istempCold1Checked =
      answers['tempCold1']?.left || answers['tempCold1']?.right;
  ...
  return (
    <>
          ...
          <View style={styles.modalContent}>
            ...
            <View style={{marginBottom: 15}}>
              <Text style={{fontSize: 15, fontWeight: '400', marginBottom: 7}}>
                <Text style={{fontWeight: 'bold'}}>{t('Cold.title1')}:</Text>{' '}
                {t('Cold.text1')}
              </Text>
              <Text style={{fontSize: 15, fontWeight: '400'}}>
                <Text style={{fontWeight: 'bold'}}>{t('Cold.title2')}:</Text>{' '}
                {t('Cold.text2')}
              </Text>
              <Text style={{fontSize: 15, fontWeight: '400'}}>
                <Text style={{fontWeight: 'bold'}}>{t('Cold.title3')}:</Text>{' '}
                {t('Cold.text3')}
              </Text>
            </View>
            <TouchableOpacity
      ...
      <View style={styles.titleBox}>
        <Text style={styles.titleTxt}>{t('Cold.title8')}</Text>
      </View>
      <View>
        <Text
          style={{
