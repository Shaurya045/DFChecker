    ...
    <>
      ...
      <View>
        <Text
          ...
          Does the foot feel hotter than the other foot or hotter than it
                        ...
                        <TouchableOpacity
                          ...
                          <View
                            style={[
                              ...
                              answers['tempHot1']?.left && item.id !== 'tempHot1' && styles.disabledCheckbox,
                            ]}>
                        ...
                        <TouchableOpacity
                          ...
                          <View
                            style={[
                              ...
                              answers['tempHot1']?.right && item.id !== 'tempHot1' && styles.disabledCheckbox,
                            ]}>
